...
func main() {
	...
	router.HandleFunc(newrelic.WrapHandleFunc(app, "/hotels", GetCities)).Methods("GET")
	router.HandleFunc(newrelic.WrapHandleFunc(app, "/hotels/{city}", GetHotels)).Methods("GET")
